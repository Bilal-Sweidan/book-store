...
export default function AddBook_comp() {
    ...
    return (
        <div className=' rounded px-3 py-3 h-100'>
            <h2 className="text-capitalize d-flex align-items-end gap-2" style={{ fontFamily: "BebasNeue" }}><GiBookshelf size={"45px"} color='orange' /> add new book</h2>
            <form action="" method='dialog' className="add-book d-flex text-capitalize w-100 gap-4" onSubmit={fetchData}>
                <div className='w-50'>
                    ...
                    <nav className='d-flex gap-3'>
                        ...
                        <Link to="/add-author" className='btn btn-primary w-25 h-100'><TbPencilPlus size={"20px"} /></Link>
                    </nav>
